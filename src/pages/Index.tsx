...
const features = [
  { icon: Users, title: "تسجيل الأطفال", description: "سجّل بيانات أطفالك بسهولة وتابع تطورهم الرياضي مع ملفات شخصية متكاملة", color: "from-primary to-blue-500" },
  { icon: Target, title: "اختبار القدرات", description: "27 سؤال ذكي يحلل 8 قدرات بدنية وذهنية لطفلك بدقة عالية", color: "from-secondary to-red-400" },
  { icon: Trophy, title: "اقتراح الرياضة", description: "توصيات مبنية على تحليل علمي شامل مع نسب التوافق لـ 11 رياضة", color: "from-primary to-sky-500" },
  ...
  { icon: MapPin, title: "أماكن التدريب", description: "اكتشف الأندية ومراكز التدريب القريبة مع التقييمات والموقع على الخريطة", color: "from-secondary to-rose-400" },
  { icon: BookOpen, title: "نصائح متخصصة", description: "إرشادات غذائية وذهنية ولياقية مصنّفة من خبراء رياضة الأطفال", color: "from-primary to-indigo-500" },
];
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden overflow-y-auto">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl overflow-hidden shadow-soft animate-glow-pulse">
              <img src={helmLogo} alt="حلم" className="w-full h-full object-contain" />
            </div>
            <div className="flex flex-col">
              <span className={cn("text-lg sm:text-xl font-black leading-none transition-colors", navOpacity > 0.5 ? "text-foreground" : "text-white")}>حلم</span>
              <span className={cn("text-[9px] leading-none mt-0.5 hidden sm:block transition-colors", navOpacity > 0.5 ? "text-muted-foreground" : "text-white/50")}>ابنى بطل أولمبي</span>
            </div>
          </div>
          <div className="flex items-center gap-2.5">
            <Button
      ...
      <section className="relative min-h-[100svh] flex items-center overflow-hidden" aria-labelledby="hero-heading" style={{ contain: 'paint' }}>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[hsl(211,50%,10%)] via-[hsl(215,40%,15%)] to-background" />
        <div className="absolute inset-0 bg-gradient-to-r from-[hsl(211,55%,8%,0.5)] via-transparent to-[hsl(4,40%,12%,0.3)]" />
        ...
        {!isMobile ? (
          ...
          <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
            ...
            {/* Glowing dots with brand colors */}
            <div className="absolute top-[15%] left-[50%] w-3 h-3 rounded-full bg-blue-400/50 animate-pulse" style={{ animationDuration: '3s' }} />
            <div className="absolute top-[60%] right-[20%] w-2.5 h-2.5 rounded-full bg-red-400/40 animate-pulse" style={{ animationDuration: '4s', animationDelay: '1s' }} />
            <div className="absolute bottom-[38%] left-[25%] w-3 h-3 rounded-full bg-blue-300/40 animate-pulse" style={{ animationDuration: '3.5s', animationDelay: '2s' }} />
            <div className="absolute top-[35%] right-[50%] w-2 h-2 rounded-full bg-red-300/35 animate-pulse" style={{ animationDuration: '5s', animationDelay: '0.5s' }} />
          </div>
        )}
        ...
        <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] border border-blue-400/5 rounded-full animate-rotate-slow z-[2] pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/4 w-[200px] h-[200px] border border-red-400/5 rounded-full animate-rotate-slow z-[2] pointer-events-none" style={{ animationDirection: 'reverse' }} />
        ...
        <div className="relative container mx-auto px-5 sm:px-6 pt-20 sm:pt-32 pb-12 sm:pb-20 text-center z-[4]">
          {/* Hero Logo with glow */}
          <div className="relative w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 mx-auto mb-6 sm:mb-8">
            {/* Ripple effect behind logo */}
            <div className="absolute inset-0 rounded-3xl bg-blue-500/10" style={{ animation: 'ripple 3s ease-out infinite' }} />
            <div className="absolute inset-0 rounded-3xl bg-blue-500/5" style={{ animation: 'ripple 3s ease-out infinite 1s' }} />
            <div className="relative w-full h-full rounded-3xl overflow-hidden animate-scale-in shadow-[0_0_60px_rgba(30,100,200,0.3)] border-2 border-white/10 bg-white/[0.06] backdrop-blur-md p-3 sm:p-4 animate-glow-pulse">
              <img src={helmLogo} alt="حلم" className="w-full h-full object-contain drop-shadow-lg" />
            </div>
          </div>

          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-white/[0.08] backdrop-blur-md text-blue-300 text-xs sm:text-sm font-semibold mb-6 sm:mb-8 animate-fade-in border border-white/10 shadow-[0_0_30px_rgba(30,100,200,0.15)]">
          ...
          <h1 id="hero-heading" className="text-[2rem] sm:text-5xl md:text-6xl lg:text-[5rem] font-black text-white mb-3 sm:mb-6 animate-slide-up leading-[1.2] tracking-tight drop-shadow-[0_2px_30px_rgba(0,0,0,0.3)]">
            ابنى بطل
            <br />
            <span className="bg-gradient-to-l from-blue-300 via-blue-400 to-sky-300 bg-clip-text text-transparent">
              أولمبي
            </span>
          </h1>

          {/* Dual-color accent line */}
          <div className="flex items-center justify-center gap-1 mb-4 sm:mb-6 animate-scale-in" style={{ animationDelay: '300ms' }}>
            <div className="w-8 sm:w-10 h-1 rounded-full bg-gradient-to-r from-blue-400 to-blue-500" />
            <div className="w-3 h-1 rounded-full bg-gradient-to-r from-red-400 to-red-500" />
            <div className="w-8 sm:w-10 h-1 rounded-full bg-gradient-to-r from-blue-500 to-sky-400" />
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 justify-center animate-slide-up" style={{ animationDelay: '250ms' }}>
            <Button
              onClick={() => navigate("/auth")}
              size="lg"
              className="w-full sm:w-auto gradient-primary text-primary-foreground text-base sm:text-lg px-8 sm:px-12 shadow-[0_0_40px_rgba(30,100,200,0.35)] hover:shadow-[0_0_60px_rgba(30,100,200,0.5)] transition-all hover:scale-[1.03] rounded-2xl press-effect shine-effect group"
            >
              ابدأ الآن مجاناً
            ...
            >
              <Play className="w-4 h-4 ml-2 text-blue-400" />
              تعرّف على المزيد
            </Button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-5 mt-10 sm:mt-20 animate-fade-in max-w-3xl mx-auto" style={{ animationDelay: '400ms' }} role="list" aria-label="إحصائيات">
            {stats.map((stat, i) => (
              <div key={stat.label} className="text-center backdrop-blur-md bg-white/[0.06] border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/[0.1] transition-all hover:scale-[1.02]" role="listitem" style={{ animationDelay: `${400 + i * 80}ms` }}>
                <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-blue-500/15 flex items-center justify-center mx-auto mb-1.5 sm:mb-2">
                  <stat.icon className="w-4 sm:w-5 h-4 sm:h-5 text-blue-400" />
                </div>
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-10 text-[10px] sm:text-xs text-white/40 animate-fade-in flex-wrap" style={{ animationDelay: '600ms' }}>
            <span className="flex items-center gap-1.5"><Shield className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-blue-400/50" /> بيانات مشفرة</span>
            <span className="flex items-center gap-1.5"><Clock className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-blue-400/50" /> 8 دقائق فقط</span>
            <span className="flex items-center gap-1.5"><CheckCircle2 className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-red-400/50" /> مجاني 100%</span>
          </div>

          {/* Scroll indicator */}
          <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 animate-bounce-gentle">
      ...
      <section className="relative container mx-auto px-4 sm:px-6 py-16 sm:py-24" aria-labelledby="features-heading">
        ...
        <AnimatedSection className="text-center mb-10 sm:mb-16">
          ...
          <div className="flex items-center justify-center gap-1 mb-4">
            <div className="w-10 h-[3px] rounded-full bg-gradient-to-r from-primary to-accent" />
            <div className="w-2 h-[3px] rounded-full bg-secondary" />
          </div>
            ...
            <AnimatedSection key={i} delay={i * 100}>
              <Card className="card-premium border-border/30 group h-full bg-card/80 backdrop-blur-sm">
                <CardContent className="p-5 sm:p-7">
                  <div className={cn(
                    "feature-icon w-12 sm:w-14 h-12 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br flex items-center justify-center mb-4 sm:mb-5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm",
                    feature.color
                  )}>
      ...
      <section className="relative overflow-hidden py-16 sm:py-24" aria-labelledby="steps-heading">
        ...
        <div className="orb orb-secondary w-48 h-48 bottom-10 right-10 opacity-[0.04]" />
            ...
            {steps.map((item, i) => (
              <AnimatedSection key={i} delay={i * 150} className="text-center group">
                <div className="relative mb-3 sm:mb-5">
                  <div className="w-14 sm:w-20 h-14 sm:h-20 rounded-2xl sm:rounded-3xl gradient-primary flex items-center justify-center mx-auto text-primary-foreground font-black text-xl sm:text-3xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-[var(--shadow-md)] group-hover:shadow-[var(--shadow-glow)] relative overflow-hidden shine-effect">
                    {item.step}
                  </div>
                  {/* Connector line */}
                  {i < steps.length - 1 && (
      ...
      <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-24" aria-labelledby="benefits-heading">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 sm:gap-16 items-center">
          <AnimatedSection>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/8 text-secondary text-xs font-bold mb-5 border border-secondary/10">
              <Heart className="w-3.5 h-3.5" /> لماذا حلم؟
            </span>
          ...
          <AnimatedSection delay={200}>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="stat-card text-center group hover:scale-[1.02]">
                  <div className="w-10 h-10 rounded-xl bg-primary/8 flex items-center justify-center mx-auto mb-3 group-hover:bg-primary/15 transition-colors group-hover:rotate-6 transition-all duration-300">
      ...
      <section className="relative overflow-hidden py-16 sm:py-24" aria-labelledby="testimonials-heading">
        ...
        <div className="relative container mx-auto px-4 sm:px-6">
          <AnimatedSection className="text-center mb-10 sm:mb-14">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/8 text-secondary text-xs font-bold mb-4 sm:mb-5 border border-secondary/10">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">أكثر من 500 عائلة استفادت من حلم</p>
          </AnimatedSection>
      ...
      <section className="relative container mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <AnimatedSection className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-card to-secondary/5 border border-border/50 p-8 sm:p-12 text-center">
          <div className="absolute top-0 right-0 w-40 h-40 rounded-full bg-primary/5 -translate-y-1/2 translate-x-1/2 animate-pulse-soft" />
          <div className="absolute bottom-0 left-0 w-32 h-32 rounded-full bg-secondary/5 translate-y-1/2 -translate-x-1/2 animate-pulse-soft" style={{ animationDelay: '1.5s' }} />
          <div className="relative z-10">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl gradient-primary flex items-center justify-center mx-auto mb-5 shadow-[var(--shadow-lg)] animate-bounce-gentle">
              <ArrowDown className="w-8 h-8 sm:w-10 sm:h-10 text-primary-foreground" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">حمّل تطبيق حلم</h2>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28" aria-labelledby="cta-heading">
        ...
        {/* Decorative circles */}
        <div className="absolute top-10 right-10 w-64 h-64 rounded-full border border-primary-foreground/5 animate-rotate-slow" />
        <div className="absolute bottom-10 left-10 w-48 h-48 rounded-full border border-primary-foreground/5 animate-rotate-slow" style={{ animationDirection: 'reverse' }} />
        ...
        <AnimatedSection className="relative container mx-auto px-4 sm:px-6 text-center">
          <div className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl bg-primary-foreground/10 backdrop-blur-sm flex items-center justify-center mx-auto mb-5 sm:mb-6 shadow-[var(--shadow-lg)] animate-bounce-gentle">
        ...
        <div className="container mx-auto px-4 sm:px-6">
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-10 h-10 rounded-xl overflow-hidden shadow-soft">
                  <img src={helmLogo} alt="حلم" className="w-full h-full object-contain" loading="lazy" />
                </div>
                <span className="font-black text-foreground text-xl">حلم</span>
              </div>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} حلم. جميع الحقوق محفوظة
            </p>
